...
parser.add_argument("--uaa", dest='uaa', default='', help="UAA issuerId (Token URI)")
parser.add_argument("--client", dest='client', default='', help="UAA Client")
parser.add_argument("--secret", dest='secret', default='', help="UAA Client secret")
parser.add_argument("--username", dest='username', default='', help="username from UAA with access to time-series")
parser.add_argument("--password", dest='password', default='', help="password user from UAA")
parser.add_argument("--token", dest='token', default='', help="specify the UAA token with access to time-series")
